...
<div class="card shadow-sm border-0 rounded-4">
    ...
    <table class="table table-hover align-middle table-borderless">
        ...
        <tbody>
            ...
            <tr>
                {{-- Customer Name with Profile --}}
                <td>
                    <div class="d-flex align-items-center">
                        <img src="{{ $customer->profile_imge ? asset('storage/' . $customer->profile_imge) : 'https://api.dicebear.com/9.x/notionists/svg?seed=' . $customer->first_name }}" 
                             alt="Profile" 
                ...
                <td class="text-dark">
                    <div class="d-flex">
                        <span class="me-2 align-self-start mt-1">🏠</span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-4 mb-4 mb-md-0">
                                        <div class="bg-light rounded-3 p-3 h-100">
                                            ...
                                            <h6 class="fw-bold text-dark text-center mb-1">{{ $customer->first_name ." ". $customer->last_name}}</h6>
    ...
    <nav>{{$customers->links()}}</nav>
        ...
        <style>
            ...
            /* Make table cells wrap content naturally */
            .table {
                width: 100%;
                table-layout: auto;
            }
            
            /* Ensure all content is visible without truncation */
            .table td {
                white-space: normal;
            ...
            /* Fixed width only for action column */
            .table td:last-child {
                white-space: nowrap;
                width: 1%;
            }
            
            /* Address section - allow multi-line */
            .table td:nth-child(3) {
                max-width: 300px;
                min-width: 200px;
            }
            
            /* Email section - break long emails */
            ...
            @media (max-width: 768px) {
                ...
                .table td[data-label="Cus. Name"]::before { content: "Name:"; }
                .table td[data-label="Cus. Email"]::before { content: "Email:"; }
                .table td[data-label="Cus. Address"]::before { content: "Address:"; }
                .table td[data-label="Created At"]::before { content: "Created:"; }
                .table td[data-label="Action"]::before { content: "Action:"; }
            }
        </style>
